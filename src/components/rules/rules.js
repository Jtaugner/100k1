    ...
    return (
        <>
            ...
            <div className="rules">
                ...
                <p>За каждый правильный ответ вам начисляется определённое количество денег, которые нужно использовать для открытия других уровней. <span className={'underline'}>Открытие уровня стоит 100 единиц игровой валюты.</span></p>
